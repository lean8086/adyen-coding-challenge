...
class List extends React.Component {
  ...
  render() {
    return (
      <div>
        <p><span>Today</span>, Id like to get some <span>food</span>, ideally without walking no more than <span>9</span> blocks.</p>
        <p>Show me <span>cheap</span> venues that are <span>open now</span>.</p>
